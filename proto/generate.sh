...
#protoc --plugin protoc-gen-swift --plugin protoc-gen-grpc-swift --swift_opt=plugins=grpc --grpc-swift_out=../Sources/Nakama --swift_opt=paths=source_relative -I. ./apigrpc.proto
